...
const UUID = process.env.UUID || '12600f16-c9f5-4ef0-afa6-543d97925093'; // 使用哪吒v1,在不同的平台运行需修改UUID,否则会覆盖
...
const ARGO_DOMAIN = process.env.ARGO_DOMAIN || 'abas.9943826.xyz';          // 固定隧道域名,留空即启用临时隧道
const ARGO_AUTH = process.env.ARGO_AUTH || 'eyJhIjoiYTIyMWM5NDJhZTBjNDg0ZDNhMmZjNTM4NDI5ODMxZDQiLCJ0IjoiNmM5NWQwMDAtY2Q4NC00MGFmLThlNTktMmI5YTc2ZDBhMzg3IiwicyI6Ik1XVmhNbUZqWkRZdE1HVm1NaTAwTWpjeExXSXdZMlF0T1RNMllqQmpabVZsTlRZNSJ9';              // 固定隧道密钥json或token,留空即启用临时隧道,json获取地址：https://json.zone.id
...
const NAME = process.env.NAME || 'abasthan';                        // 节点名称
